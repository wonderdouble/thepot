...
export default function makeQuery () {
    ...
    async function getMailer (httpRequest) {
        return new Promise((resolve,reject)=>{
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; border: 1px solid #cccccc;">
                                <tr>
                                    <td bgcolor="#edebea" align="center"  style="padding: 30px 10px;">
                                        <img src="https://wonderdouble-assets.s3.eu-west-1.amazonaws.com/logo.png" alt="WonderDouble banner" width="170" title="" style="display: block;" />
                                ...
                                <tr>
                                    <td align="center" bgcolor="#353d65" style="padding: 10px 0; color:#ffffff;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%"  style="border-collapse: collapse;">
                                            <tr>
                                                <td align="center" valign="top">
                                                    <p>ADDRESS<br>
                                                        13A Ayo Babatunde Crescent,<br>Off Akiogun Road, Oniru Lekki Phase 1<br>Lagos State.<br><br><span style="font-size:14px;">+234 905 612 9950, +234 902 787 0714<br> info@wonderdoubleglobal.com</span>
                                                    </p>
                                                </td> 
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td align="center" bgcolor="#edebea">
                                       <p style="color:#343c64; font-size:14px;">&copy Wonder Double Global 2021</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            from: {
                email: 'info@wonderdoubleglobal.com',
                name: 'WonderDouble'
            },
